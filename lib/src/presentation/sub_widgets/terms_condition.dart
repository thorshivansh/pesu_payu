              ...
              SizedBox(
                ...
                child: DataTable(
                  ...
                  rows: const <DataRow>[
                    ...
                    DataRow(
                      cells: <DataCell>[
                        DataCell(MyText('Debit card Rupay*	')),
                        DataCell(MyText('Nil')),
                      ],
                    ),
                    DataRow(
                      cells: <DataCell>[
                        DataCell(MyText('Internet Banking (SBI)	')),
                        DataCell(MyText('Rs.12+taxes')),
                      ],
                    ),
                    DataRow(
                      cells: <DataCell>[
                        DataCell(MyText('Internet Banking (HDFC,ICICI,AXIS)	')),
                        DataCell(MyText('Rs.12+taxes')),
                      ],
                    ),
                    DataRow(
                      cells: <DataCell>[
                        DataCell(MyText('Internet Banking (others)	')),
                        DataCell(MyText('Rs.12+taxes')),
                      ],
                    ),
                    DataRow(
                      cells: <DataCell>[
                        DataCell(
                            MyText('Debit Card upto 2000 other than Rupay	')),
                        DataCell(MyText('0.40%+taxes')),
                      ],
                    ),
                    DataRow(
                      cells: <DataCell>[
                        DataCell(
                            MyText('Debit Card above 2000 other than Rupay	')),
                        DataCell(MyText('0.40%+taxes')),
                      ],
                    ),
                    DataRow(
                      cells: <DataCell>[
                        DataCell(MyText('Credit card	')),
                        DataCell(MyText('0.40%+taxes')),
                      ],
                    ),
                  ],
